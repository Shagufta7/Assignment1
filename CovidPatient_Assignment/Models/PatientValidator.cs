...
namespace CovidPatient_Assignment.Models
{
    public class PatientValidator : AbstractValidator<Patient>
    {
        public PatientValidator()
        {
            ...
            RuleFor(expression: model => model.PassportNumber).NotEmpty().WithMessage("PassportNumber is required");
            RuleFor(expression: model => model.Emirates_ID).NotEmpty().WithMessage("Emirates_ID is required");
